...
export const TableDrawer = ({ onClose, table }: TableDrawerProps) => {
  ...
  return (
    <>
      ...
      {/* drawer */}
      <div className="fixed inset-x-0 bottom-[var(--mobile-bottom-nav-clearance)] z-50 flex max-h-[calc(100dvh-var(--mobile-bottom-nav-clearance))] w-full flex-col rounded-t-3xl border-t border-gray-200 bg-white shadow-2xl dark:border-gray-800 dark:bg-gray-900 md:inset-y-0 md:left-auto md:right-0 md:top-0 md:max-h-none md:w-80 md:rounded-none md:rounded-l-2xl md:border-l md:border-t-0">
        {/* Header */}
