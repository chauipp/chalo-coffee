  ...
  return (
    <>
      ...
      <div className="fixed right-0 top-0 bottom-0 z-50 w-80 bg-white dark:bg-stone-900 shadow-2xl border-l border-stone-200 dark:border-stone-800 flex flex-col">
        ...
        {/* Status badge */}
        <div className="px-5 py-3 border-b border-stone-100 dark:border-stone-800 shrink-0">
          <div
        ...
        <div className="flex-1 overflow-y-auto px-5">
          {table.status === "AVAILABLE" || table.activeOrders.length === 0 ? (
            ...
            <>
              <p className="text-xs font-semibold text-stone-500 dark:text-stone-400 uppercase tracking-wider pt-4 pb-2">
        ...
        {table.status === "OCCUPIED" &&
          ...
          totalUnpaid > 0 && (
            <div className="px-5 py-4 border-t border-stone-100 dark:border-stone-800 shrink-0">
        ...
        <div className="px-5 pb-4 shrink-0">
          <p className="text-[10px] font-mono text-stone-400 dark:text-stone-600 break-all">
            {table.qrToken}
          </p>
        </div>
      </div>
