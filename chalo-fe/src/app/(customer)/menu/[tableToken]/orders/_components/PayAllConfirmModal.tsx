...
export const PayAllConfirmModal = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center bg-black/50 backdrop-blur-sm px-0 sm:px-4">
      <div className="w-full sm:max-w-sm bg-white dark:bg-stone-900 rounded-t-3xl sm:rounded-3xl shadow-2xl p-6 pb-8 sm:pb-6">
        ...
        <h2 className="text-center text-base font-bold text-stone-900 dark:text-white mb-1">
          Xác nhận thanh toán tất cả
        </h2>
        <p className="text-center text-sm text-stone-500 dark:text-stone-400 mb-2">
        ...
        <div className="space-y-2.5">
          ...
          <button
            onClick={onCancel}
            disabled={isPending}
            className="w-full rounded-2xl border border-stone-200 dark:border-stone-700 py-3.5 text-sm font-semibold text-stone-600 dark:text-stone-400 hover:bg-stone-50 dark:hover:bg-stone-800 transition-all disabled:opacity-60"
          >
            Huỷ
          </button>
        </div>
