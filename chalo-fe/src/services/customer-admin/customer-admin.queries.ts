...
export const useGetCustomerLoyaltyHistory = (id: number) =>
  useQuery({
    queryKey: QUERY_KEYS.CUSTOMERS.LOYALTY_HISTORY(id, { pageNo: 1, pageSize: 5 }),
    queryFn: () => getCustomerLoyaltyHistory(id),
    staleTime: 30_000,
  });
