...
export class AddSepayPayment1784850000000 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "sepay_transactions" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "sepayTxId" character varying(64) NOT NULL, "transferAmount" integer NOT NULL, "content" text, "accountNumber" character varying(30), "transactionDate" character varying(32), "matchedSessionId" uuid, "status" "public"."sepay_transactions_status_enum" NOT NULL, "rawPayload" json NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_sepay_transactions_id" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_sepay_transactions_sepayTxId" ON "sepay_transactions" ("sepayTxId")`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`DROP INDEX "public"."IDX_sepay_transactions_sepayTxId"`);
