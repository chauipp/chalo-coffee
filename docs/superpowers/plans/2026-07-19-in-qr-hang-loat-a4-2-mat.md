...
### Task 1: Tách `@page` khỏi `A6_PRINT_CSS` để trang sheet dùng `@page A4` [x]
...
### Task 2: Hàm thuần dàn tờ + đảo mặt sau (`qr-sheet-layout.ts`) [x]
...
### Task 3: Component 1 mặt A4 (`A4Face.tsx`) + CSS lưới/vạch cắt [x]
...
### Task 4: Route in hàng loạt (`print-sheet/page.tsx`) [x]
...
### Task 5: Chọn bàn (checkbox + thanh thao tác) ở trang Bàn & QR [x]
...
### Task 6: Mở rộng `/qr-preview` để duyệt 4-up 2 mặt + verify trực quan [x]
